...
de la entrante, ya que en esta última se imponen 
...
Si se multiplica la ETR~\eqref{eq:RTE} por la variable angular $\hth$, y se integra 
...
La ecuación  de transporte puede resolverse expandiendo 
la parte angular en armónicos esféricos, 
lo que da lugar a la aproximación $P_N$. Lejos de los bordes la intensidad de radiación puede expandirse como 
\begin{equation}
\begin{split}
\begin{aligned}
...
donde $Y_{l,m}(\tilde{\theta},\varphi)$ representa al armónico esférico de grado $l$ y orden $m$~\cite{Sansone1991}.
 ...
 Dado que la dispersión tiende a promediar a la función de distribución $\ut$ con respecto a la variable $\hth$, volviéndola isótropa, es esperable que en el régimen difusivo la función $u(\x,\hth,t)$ varíe suavemente. En ese caso, se puede 
...
en el régimen difusivo, y lejos de las fuentes~\cite{Hielscher1998}. El problema radica en las condiciones de contorno. Se han desarrollado diferentes teorías para el tratamiento de las 
...
(que definiremos más adelante) en los puntos del extremo 
...
Estas se obtienen de resolver un problema de minimización 
...
Cabe destacar que este procedimiento  solo se usa para obtener un pequeño archivo con parámetros 
...
de variable también son posibles) genera una densidad de puntos espaciales en la cercanía 
del borde de modo tal que permita resolver apropiadamente a la capa límite 
en la variable espacial. Para que la integral colisional sea correctamente 
