...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Las columnas de la matriz $\bar{Q}$ son los valores de los polinomios ortogonales 
...
Cabe destacar que este procedimiento debe realizarse una única vez 
...
%\label{eq:SVD}
%\end{equation}
%donde el vector $\vec{a}$ contiene los coeficientes del polinomio trigonométrico interpolante 
%de $f$ en la grilla numérica sobremuestreada, la matriz $\bar{B}^s$ se obtiene 
%de evaluar la función~\eqref{} en los puntos $I_{\text{c}}$, $ \vec{q_j}^s(x)$ son las columnas 
%de la matriz $\bar{Q}^s$ en la ecuación~\eqref{eq:qsob} y $\vec{0}$ es el vector nulo de dimensión $(Z-1)\times N_s +1$
