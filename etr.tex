...
\label{cap:forw}
\lhead{\thepage}
\rhead{\textit{El problema directo}} 


\clearpage \pagebreak  En este trabajo resolvemos el problema {\bf inverso} 
...
\State \hskip1.5em Aplicar la Transformada Rápida de Fourier para obtener Ec.~\eqref{eq:RTEFCSum}.
...
en la cual los fotones viajan libremente. Esta característica 
