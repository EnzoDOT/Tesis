...
para indica el teimpo de retraso temporal correspondiente $\tau_{k,1}$ (ver la Ecuación~\eqref{eq:RTEsources}).
...
\\
 ...
 \label{fig:itdet}
\end{figure*}
Esta configuración fue guiada por la idea de utilizar en el método FMS como fuentes superpuestas 
...
la 
totalidad de $\partial \Omega$, que si esas fuentes son simuladas en problemas 
