...
\clearpage \pagebreak En las secciones previas abordamos el problema {\bf directo} de transporte 
...
en una misma cara. Emplamos la notación $\x_{k,1}$ para 
indicar la posición de cada fuente láser activada a tiempo $\tau_{k,1}$ ($k=1,\ldots,16$).
En la Tabla~\ref{tab:necksrc} se muestran los tiempos de activación para cada fuentes 
...
un modelo de cabeza similar. En nuestros cálculos empleamos 16 fuentes y 32 detectores, 
