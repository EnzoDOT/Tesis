...
\end{figure}
Para la resolución del problema inverso, utilizamos el esquema \textit{MOBIIR}, 
presentado en la sección siguiente. 

\pagebreak

\section{El esquma \textit{MOBIIR}}

\begin{wrapfigure}{l}{0.48\textwidth}
  \includegraphics[width=0.48\textwidth]{figuras/mobir.eps}\\
  \caption{Esquema  MOBIIR.}
 \label{fig:mobir}
\end{wrapfigure}

En este trabajo desarrollamos un algoritmo tipo MOBIIR~\cite{Hielscher1999,Kim2010} (del inglés, {\em Model Based Iterative Image  
...
\begin{eqnarray}
\gamma_{k,i}(t) & = & \frac{|t-\tau_{k,i}-\sigma_t|}{\sigma_t} ,
