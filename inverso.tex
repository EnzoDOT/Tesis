...
con la variable $\x$ discretizada, $\alpha^i$ es el largo del paso de Newton (consideraremos $\alpha^i=1$). En el caso del método de Newton (o {\em steepest descent}), la dirección de 
